...
# # PATH KONFIGURASI
# # =========================
# MODEL_PATH = r"D:\deteksi\best2.pt"
...
# # Pastikan folder rekap_penjualan ada
...
# print("📸 Tekan 's' untuk ambil foto | 'q' untuk keluar")
...
#         print("✅ Foto disimpan:", IMAGE_PATH)
...
#         # =========================
#         # 5. Simpan hasil ke penjualan.txt
#         # =========================
...
#         print("📝 Hasil deteksi disimpan ke penjualan.txt")
...
# print("📸 Tekan 's' untuk mulai transaksi | 'q' untuk keluar")
...
#         # FOTO 1 - PRODUK
#         # =========================
#         produk_path = os.path.join(SAVE_DIR, f"produk_{timestamp}.jpg")
#         cv2.imwrite(produk_path, frame)
#         print("✅ Foto produk disimpan")

#         # Deteksi objek
#         results = model(produk_path)
#         detected_objects = []
...
#         with open(NOTE_PATH, "a", encoding="utf-8") as f:
#             f.write(f"Foto Pembeli   : {os.path.basename(pembeli_path)}\n")

#         print("✅ Foto pembeli disimpan")
...
# print("📸 Pastikan kotak deteksi muncul → tekan 's'")
# print("❌ Jika tidak ada kotak, jangan simpan")
# print("Tekan 'q' untuk keluar")

# last_results = None   # simpan hasil deteksi terakhir
...
#     # Info di layar
#     if detected_objects:
#         status_text = "OBJEK TERDETEKSI - AMAN - tekan [s]"
#         color = (0, 255, 0)
#     else:
...
#             print("⚠️ Tidak ada objek terdeteksi! Transaksi dibatalkan.")
#             continue
